...
function loadApplicationList(P, e, a, _) {
  null == P && (P = IPSAP.USER_TYPE.RESEARCHER),
    null == e && (e = IPSAP.APP_LIST_TYPE.ALL),
    null == a && (a = !1);
  var I = [],
      ...
      switch ((I.push("app_view_set2"), e)) {
        case IPSAP.APP_LIST_TYPE.ALL:
          I.push("app_view_set1"),
            ...
            setListFilter(
              "status",
              "delayed,approved,denied,experimenting",
              "last"
            ),
        ...
        case IPSAP.APP_LIST_TYPE.CHECK:
          I.push("app_view_set3"),
            ...
            (A["filter.app_view_type"] =
              IPSAP.APP_LIST_TYPE_PARAM.ADMIN_REVIEW_OFFICE);
          break;
        case IPSAP.APP_LIST_TYPE.JUDGE_FINISH:
          I.push("app_view_set3"),
            ...
            (A["filter.app_view_type"] =
              IPSAP.APP_LIST_TYPE_PARAM.ADMIN_REVIEW_CLOSE);
      }
      break;
    case IPSAP.USER_TYPE.OFFICER:
      switch ((I.push("app_view_set2"), I.push("app_view_set3"), e)) {
        ...
        case IPSAP.APP_LIST_TYPE.FINAL_FINISH:
          A["filter.app_view_type"] =
            IPSAP.APP_LIST_TYPE_PARAM.ADMIN_REVIEW_CONFIRM;
      }
      break;
    case IPSAP.USER_TYPE.CHAIRMAN:
      switch ((I.push("app_view_set3"), e)) {
        case IPSAP.APP_LIST_TYPE.ALL:
          I.push("app_view_set2"),
            setListFilter("committee", "iacuc,ibc,irb", "last"),
            (A["filter.app_view_type"] =
              IPSAP.APP_LIST_TYPE_PARAM.CHAIRMAN_REVIEW_CONFIRM);
          break;
        case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
          I.push("proc_exec_field", "app_view_set1"),
            setListFilter("committee", "iacuc,ibc,irb", "last"),
            (A["filter.app_view_type"] =
              IPSAP.APP_LIST_TYPE_PARAM.CHAIRMAN_REVIEW_LIST);
      }
      break;
    case IPSAP.USER_TYPE.COMMITTEE:
      switch ((I.push("app_view_set3"), e)) {
        case IPSAP.APP_LIST_TYPE.ALL:
          I.push("app_view_set2"),
            (A["filter.app_view_type"] =
              IPSAP.APP_LIST_TYPE_PARAM.COMMITTEE_REVIEW);
          break;
        case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
          I.push("proc_exec_field", "app_view_set1"),
            setListFilter("committee", "iacuc,ibc,irb"),
            ...
            (A["filter.app_view_type"] =
              IPSAP.APP_LIST_TYPE_PARAM.COMMITTEE_REVIEW_LIST);
      }
      break;
    case IPSAP.USER_TYPE.ALL:
      switch ((I.push("app_view_set3"), e)) {
        case IPSAP.APP_LIST_TYPE.INSPECT_RECORD:
          I.push("app_view_set2"),
            (A["filter.app_view_type"] =
              IPSAP.APP_LIST_TYPE_PARAM.INSPECT_RECORD);
          break;
        case IPSAP.APP_LIST_TYPE.ALL:
          I.push("proc_exec_field", "app_view_set2"),
            setListFilter(
  ...
  if (
    (a
      ? (T = $(".card_templete").clone())
      : ($("#datatable").removeClass("card_type"),
        $("#datatable").addClass("list_type"),
        $("#type_changer").remove(),
        (T = $(".list_templete").clone())),
    IPSAP.DEMO_MODE)
  )
    return void n(P, e);
  ...
  function n(P, e, a) {
    ...
    IPSAP.APP_LIST_TYPE.INSPECT_RECORD != e &&
      ...
      $("input[name=list_type]").on({
        change: function (P) {
          $("#datatable").removeClass("card_type list_type"),
            $("#datatable").addClass($("input[name=list_type]:checked").val());
        },
      })),
  ...
  function c(e, a, _) {
    ...
    switch (_) {
      ...
      case IPSAP.IRB_APP_PROC_BTN_KIND.CHECK:
        a.application_result == IPSAP.APPLICATION_RESULT.CHECKING &&
          ((I = ""), (A = "btn-primary"));
        break;
      ...
      case IPSAP.IRB_APP_PROC_BTN_KIND.FINAL:
        a.application_step == IPSAP.APPLICATION_STEP.FINAL &&
          a.application_result == IPSAP.APPLICATION_RESULT.DECISION_ING &&
          ((I = ""), (A = "btn-primary"));
        break;
      ...
      success: function (_) {
        (saved_list = _.list),
          ...
          $.each(_.list, function (_, A) {
            (A.tmp_reg_dttm = getDttm(A.reg_dttm)),
              (A.tmp_approved_dttm = getDttm(A.approved_dttm)),
              (A.tmp_submit_dttm = getDttm(A.submit_dttm));
            let t = T.clone(),
              s = 0;
            if (
              (IPSAP.APP_LIST_TYPE.INSPECT_RECORD != e &&
                t.children().eq(s++).text(A.parent_app_seq),
              $(".card").removeClass("hidden"),
              t.children().eq(s++).text(A.application_no),
              P == IPSAP.USER_TYPE.CHAIRMAN || P == IPSAP.USER_TYPE.COMMITTEE
                ? P == IPSAP.USER_TYPE.COMMITTEE &&
                  e == IPSAP.APP_LIST_TYPE.JUDGE_HISTROY
                  ? ((A.tmp_normal_review_dttm = getDttm(A.normal_review_dttm)),
                    (A.tmp_expert_review_dttm = getDttm(A.expert_review_dttm)),
                    0 == A.normal_review_dttm
                      ? t.children().eq(s++).text(A.tmp_expert_review_dttm.dt)
                      : t.children().eq(s++).text(A.tmp_normal_review_dttm.dt))
                  : P == IPSAP.USER_TYPE.CHAIRMAN &&
                    e == IPSAP.APP_LIST_TYPE.JUDGE_HISTROY
            ...
            t.children().eq(s++).text(A.application_type_str),
              5 == A.application_step && 1 != A.application_type
                ? t.children().eq(s++).text("승인")
                : t.children().eq(s++).text(A.application_step_str),
              (P != IPSAP.USER_TYPE.RESEARCHER &&
                P != IPSAP.USER_TYPE.COMMITTEE &&
                P != IPSAP.USER_TYPE.CHAIRMAN) ||
              (5 != A.application_result && 6 != A.application_result)
                ? P == IPSAP.USER_TYPE.OFFICER && 5 == A.application_result
                  ? t.children().eq(s++).text("심사중")
                  : P != IPSAP.USER_TYPE.RESEARCHER ||
                    (2 != A.application_result && 3 != A.application_result)
                  ? P != IPSAP.USER_TYPE.RESEARCHER ||
                    (11 != A.application_result && 12 != A.application_result)
              ...
              e == IPSAP.APP_LIST_TYPE.ALL &&
                ...
                t.children().eq(s++).text(A.expert_member),
                    ...
                    case IPSAP.JUDGE_TYPE.IACUC:
                      switch (e) {
                        case IPSAP.APP_LIST_TYPE.ALL:
                          switch (P) {
                            case IPSAP.USER_TYPE.ADMIN_OFFICER:
                              s.push(IPSAP.APP_PROC_BTN_KIND.CHECK),
                            ...
                            case IPSAP.USER_TYPE.CHAIRMAN:
                              ...
                              break;
                            case IPSAP.USER_TYPE.COMMITTEE:
                              s.push(IPSAP.APP_PROC_BTN_KIND.PRO_JUDGE),
                                s.push(IPSAP.APP_PROC_BTN_KIND.NOR_JUDGE);
                            case IPSAP.USER_TYPE.RESEARCHER:
                          }
                          break;
                        case IPSAP.APP_LIST_TYPE.CHECK:
                    ...
                    case IPSAP.JUDGE_TYPE.IBC:
                      switch (e) {
                        case IPSAP.APP_LIST_TYPE.ALL:
                          switch (P) {
                            case IPSAP.USER_TYPE.ADMIN_OFFICER:
                              s.push(IPSAP.IBC_APP_PROC_BTN_KIND.CHECK),
                            ...
                            case IPSAP.USER_TYPE.CHAIRMAN:
                              ...
                              break;
                            case IPSAP.USER_TYPE.COMMITTEE:
                              s.push(IPSAP.IBC_APP_PROC_BTN_KIND.PRO_JUDGE),
                                s.push(IPSAP.IBC_APP_PROC_BTN_KIND.NOR_JUDGE);
                            case IPSAP.USER_TYPE.RESEARCHER:
                          }
                          break;
                        case IPSAP.APP_LIST_TYPE.CHECK:
                    ...
                    case IPSAP.JUDGE_TYPE.IRB:
                      switch (e) {
                        case IPSAP.APP_LIST_TYPE.ALL:
                          switch (P) {
                            case IPSAP.USER_TYPE.ADMIN_OFFICER:
                              s.push(IPSAP.IRB_APP_PROC_BTN_KIND.CHECK),
                                s.push(IPSAP.IRB_APP_PROC_BTN_KIND.JUDGE_SET),
                            ...
                            case IPSAP.USER_TYPE.CHAIRMAN:
                              ...
                              break;
                            case IPSAP.USER_TYPE.COMMITTEE:
                              s.push(IPSAP.IRB_APP_PROC_BTN_KIND.PRO_JUDGE),
                                s.push(IPSAP.IRB_APP_PROC_BTN_KIND.NOR_JUDGE);
                            case IPSAP.USER_TYPE.RESEARCHER:
                          }
                          break;
                        case IPSAP.APP_LIST_TYPE.CHECK:
              ...
              e == IPSAP.APP_LIST_TYPE.ALL &&
                ...
                t
                  ...
                  .attr(
                    "onClick",
                    `onClickShowDeleteApplicationModal(event,${A.application_seq},'${A.application_no}')`
                  ),
              ...
              (function (e, a) {
                if (
                  (a.removeClass("IACUC IRB IBC"),
                  a.addClass(e.judge_type_str),
                  e.application_result == IPSAP.APPLICATION_RESULT.DELETED)
                )
                  return void a.addClass("deleted");
                ...
                e.application_result == IPSAP.APPLICATION_RESULT.JUDGE_DELAY &&
                  P == IPSAP.USER_TYPE.OFFICER &&
                  a.addClass("delayed");
              })(A, t);
        ...
        _ = 0;
        A > (_ = 0 == S ? r * (S + 1) : r + parseInt(S)) &&
          setBlockBtn("next", _, r),
          S > 0 && setBlockBtn("before", _, r, S);
        let t = $(".search_form"),
          s = $(".dataTables_filter");
...
function onClickShowDeleteApplicationModal(P, e, a) {
  $(".app_no").text(a),
    $("#deleteApp").attr("onClick", `onDeleteApplication(event,'${e}')`),
    $("#modal_application_delete").modal("show"),
    P.stopPropagation();
}
function onAppNavigate(P, e, a) {
  P.stopPropagation(),
    g_AppInfo.initWithAppObj(saved_list[e]) ||
      alert("Fail to ApplicationInfo Init!"),
    g_AppInfo.saveParamsAndNavigate(a);
}
function onClickApplication(P) {
  //alert("func onClickApplication : " + P);

  switch (
    (g_AppInfo.initWithAppObj(saved_list[P]) ||
      alert("Fail to ApplicationInfo Init!"),
    saved_list[P].judge_type)
  ) {
    case IPSAP.JUDGE_TYPE.IACUC:
      navigateIACUC(P);
      break;
...
function navigateIACUC(P) {
  switch (saved_list[P].application_type) {
    ...
    default:
      return void alert(
        `application_type Error!! (${saved_list[P].application_type})`
      );
  }
}
function navigateIACUC_new(P) {
  switch (saved_list[P].application_result) {
          ...
          switch (saved_list[P].application_step) {
              ...
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IACUC_expert_1.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
                    "./application_list-info.html"
                  );
              }
              break;
            case IPSAP.APPLICATION_STEP.COMM_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IACUC_general_1.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
          ...
          switch (saved_list[P].application_step) {
            case IPSAP.APPLICATION_STEP.PRO_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IACUC_expert_2.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
      ...
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.CHAIRMAN:
          switch (g_list_type) {
            case IPSAP.APP_LIST_TYPE.ALL:
              g_AppInfo.saveParamsAndNavigate(
                "./reviewConfirm_list-review.html"
              );
              break;
            case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
              g_AppInfo.saveParamsAndNavigate("./application_list-info.html");
    ...
    default:
      return void alert(
        `APPLICATION_RESULT Error!! (${saved_list[P].application_result})`
      );
  }
}
  ...
  switch (saved_list[P].application_result) {
    ...
    case IPSAP.APPLICATION_RESULT.CHECKING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./reviewOffice_list-review_change.html"
          );
      }
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING_2:
          ...
          switch (saved_list[P].application_step) {
            case IPSAP.APPLICATION_STEP.PRO_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IACUC_expert_1_change.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
                    "./experiment_list-info_change.html"
                  );
              }
              break;
            case IPSAP.APPLICATION_STEP.COMM_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IACUC_general_1_change.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
    ...
    case IPSAP.APPLICATION_RESULT.DECISION_ING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./reviewConfirm_list-review_change.html"
          );
          break;
        case IPSAP.USER_TYPE.COMMITTEE:
          g_AppInfo.saveParamsAndNavigate("./experiment_list-info_change.html");
  ...
  switch (saved_list[P].application_result) {
    ...
    case IPSAP.APPLICATION_RESULT.CHECKING_2:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./reviewOffice_list-review_renew.html"
          );
      }
      break;
    case IPSAP.APPLICATION_RESULT.JUDGE_ING:
          ...
          switch (saved_list[P].application_step) {
            case IPSAP.APPLICATION_STEP.PRO_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IACUC_expert_1_renew.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
                    "./experiment_list-info_renew.html"
                  );
              }
              break;
            case IPSAP.APPLICATION_STEP.COMM_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IACUC_general_1_renew.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
    ...
    case IPSAP.APPLICATION_RESULT.DECISION_ING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./reviewConfirm_list-review_renew.html"
          );
          break;
        case IPSAP.USER_TYPE.COMMITTEE:
          g_AppInfo.saveParamsAndNavigate("./application_list-info.html");
  ...
  switch (saved_list[P].application_result) {
    ...
    case IPSAP.APPLICATION_RESULT.CHECKING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./reviewOffice_list-review_bring.html"
          );
      }
      break;
    case IPSAP.APPLICATION_RESULT.DECISION_ING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./reviewConfirm_list-review_bring.html"
          );
          break;
        case IPSAP.USER_TYPE.COMMITTEE:
          g_AppInfo.saveParamsAndNavigate("./experiment_list-info_bring.html");
        ...
        case IPSAP.USER_TYPE.CHAIRMAN:
          switch (g_list_type) {
            ...
            case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
              g_AppInfo.saveParamsAndNavigate(
                "./experiment_list-info_bring.html"
              );
          }
      }
      break;
  ...
  switch (saved_list[P].application_result) {
    ...
    case IPSAP.APPLICATION_RESULT.CHECKING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./reviewOffice_list-review_end.html"
          );
      }
      break;
    case IPSAP.APPLICATION_RESULT.DECISION_ING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./reviewConfirm_list-review_end.html"
          );
          break;
        case IPSAP.USER_TYPE.COMMITTEE:
          g_AppInfo.saveParamsAndNavigate("./experiment_list-info_end.html");
  ...
  switch (saved_list[P].application_result) {
    ...
    case IPSAP.APPLICATION_RESULT.CHECKING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./reviewOffice_list-review_inspection.html"
          );
      }
      break;
    case IPSAP.APPLICATION_RESULT.DECISION_ING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./reviewConfirm_list-review_inspection.html"
          );
          break;
        case IPSAP.USER_TYPE.COMMITTEE:
          g_AppInfo.saveParamsAndNavigate("./inspection_list-info.html");
    ...
    case IPSAP.APPLICATION_RESULT.ACCEPT:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.CHAIRMAN:
          g_AppInfo.saveParamsAndNavigate(
            "./experiment_list-info_inspection.html"
          );
      }
      break;
    default:
  ...
  switch (saved_list[P].application_result) {
    ...
    case IPSAP.APPLICATION_RESULT.CHECKING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.ALL:
          g_AppInfo.saveParamsAndNavigate(
            "./IBC/application_list-IBC_info.html"
          );
          break;
        case IPSAP.USER_TYPE.ADMIN_OFFICER:
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./IBC/reviewOffice_list-IBC_review.html"
          );
      }
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING_2:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./IBC/reviewOffice_list-IBC_setup.html"
          );
      }
      break;
    case IPSAP.APPLICATION_RESULT.JUDGE_ING:
          ...
          switch (saved_list[P].application_step) {
            case IPSAP.APPLICATION_STEP.PRO_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IBC_expert_1.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
            ...
            case IPSAP.APPLICATION_STEP.COMM_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IBC_general_1.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
          ...
          switch (saved_list[P].application_step) {
            case IPSAP.APPLICATION_STEP.PRO_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IBC_expert_2.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
    ...
    case IPSAP.APPLICATION_RESULT.DECISION_ING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./IBC/reviewConfirm_list-IBC_review.html"
          );
          break;
        case IPSAP.USER_TYPE.COMMITTEE:
          g_AppInfo.saveParamsAndNavigate(
...
function navigateIBC_change(P) {
  switch (saved_list[P].application_result) {
    case IPSAP.APPLICATION_RESULT.SUPPLEMENT:
      g_AppInfo.saveParamsAndNavigate(
        "./IBC/experiment_list-IBC_review_change.html"
      );
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.ALL:
          g_AppInfo.saveParamsAndNavigate(
            "./IBC/experiment_list-IBC_info_change.html"
          );
          break;
        case IPSAP.USER_TYPE.ADMIN_OFFICER:
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./IBC/reviewOffice_list-IBC_review_change.html"
          );
      }
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING_2:
          ...
          switch (saved_list[P].application_step) {
            case IPSAP.APPLICATION_STEP.PRO_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IBC_expert_1_change.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
            ...
            case IPSAP.APPLICATION_STEP.COMM_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IBC_general_1_change.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
...
function navigateIRB_new(P) {
  //alert("func navigateIRB_new : " + saved_list[P].application_result);
  ...
  switch (saved_list[P].application_result) {    
    case IPSAP.APPLICATION_RESULT.TEMP:
      ...
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING: 
      if (g_user_type === IPSAP.USER_TYPE.RESEARCHER)  
        g_AppInfo.saveParamsAndNavigate("./IRB/application_list-IRB_info.html");  
  }
  */
  ...
  switch (saved_list[P].application_result) {
    case IPSAP.APPLICATION_RESULT.TEMP:
      ...
      break;
    case IPSAP.APPLICATION_RESULT.SUPPLEMENT:
      g_AppInfo.saveParamsAndNavigate("./IRB/application_list-IRB_review.html");
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING:
      switch (g_user_type) {
        case IPSAP.USER_TYPE.RESEARCHER:
        case IPSAP.USER_TYPE.ALL:
          g_AppInfo.saveParamsAndNavigate(
            "./IRB/application_list-IRB_info.html"
          );
          break;
        case IPSAP.USER_TYPE.ADMIN_OFFICER:
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./IRB/reviewOffice_list-IRB_review.html"
          );
      }
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING_2:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./IRB/reviewOffice_list-IRB_setup.html"
          );
      }
      break;
    case IPSAP.APPLICATION_RESULT.JUDGE_ING:
          ...
          switch (saved_list[P].application_step) {
            case IPSAP.APPLICATION_STEP.PRO_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IRB_expert_1.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
            ...
            case IPSAP.APPLICATION_STEP.COMM_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IRB_general_1.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
          ...
          switch (saved_list[P].application_step) {
            case IPSAP.APPLICATION_STEP.PRO_JUDGE:
              switch (g_list_type) {
                case IPSAP.APP_LIST_TYPE.ALL:
                  g_AppInfo.saveParamsAndNavigate(
                    "./review_list-review_IRB_expert_2.html"
                  );
                  break;
                case IPSAP.APP_LIST_TYPE.JUDGE_HISTROY:
                  g_AppInfo.saveParamsAndNavigate(
    ...
    case IPSAP.APPLICATION_RESULT.DECISION_ING:
      switch (g_user_type) {
        ...
        case IPSAP.USER_TYPE.OFFICER:
          g_AppInfo.saveParamsAndNavigate(
            "./IRB/reviewConfirm_list-IRB_review.html"
          );
          break;
        case IPSAP.USER_TYPE.COMMITTEE:
          g_AppInfo.saveParamsAndNavigate(
...
function navigateIRB_change(P) {
  switch (saved_list[P].application_result) {
    ...
    case IPSAP.APPLICATION_RESULT.CHECKING:
      if (g_user_type === IPSAP.USER_TYPE.RESEARCHER)
        g_AppInfo.saveParamsAndNavigate(
          "./IRB/experiment_list-IRB_info_change.html"
        );
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING_2:
      alert("개발중!");
...
function navigateIRB_maintanance(P) {
  switch (saved_list[P].application_result) {
    ...
    case IPSAP.APPLICATION_RESULT.CHECKING:
      if (g_user_type === IPSAP.USER_TYPE.RESEARCHER)
        g_AppInfo.saveParamsAndNavigate(
          "./IRB/experiment_list-IRB_info_renew.html"
        );
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING_2:
      alert("개발중!");
...
function navigateIRB_adverse(P) {
  switch (saved_list[P].application_result) {
    ...
    case IPSAP.APPLICATION_RESULT.CHECKING:
      if (g_user_type === IPSAP.USER_TYPE.RESEARCHER)
        g_AppInfo.saveParamsAndNavigate(
          "./IRB/experiment_list-IRB_info_adverse.html"
        );
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING_2:
      alert("개발중!");
...
function navigateIRB_violation(P) {
  switch (saved_list[P].application_result) {
    ...
    case IPSAP.APPLICATION_RESULT.CHECKING:
      if (g_user_type === IPSAP.USER_TYPE.RESEARCHER)
        g_AppInfo.saveParamsAndNavigate(
          "./IRB/experiment_list-IRB_info_violation.html"
        );
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING_2:
      alert("개발중!");
...
function navigateIRB_problem(P) {
  switch (saved_list[P].application_result) {
    ...
    case IPSAP.APPLICATION_RESULT.CHECKING:
      if (g_user_type === IPSAP.USER_TYPE.RESEARCHER)
        g_AppInfo.saveParamsAndNavigate(
          "./IRB/experiment_list-IRB_info_problem.html"
        );
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING_2:
      alert("개발중!");
...
function navigateIRB_end(P) {
  switch (saved_list[P].application_result) {
    ...
    case IPSAP.APPLICATION_RESULT.CHECKING:
      if (g_user_type === IPSAP.USER_TYPE.RESEARCHER)
        g_AppInfo.saveParamsAndNavigate(
          "./IRB/experiment_list-IRB_info_end.html"
        );
      break;
    case IPSAP.APPLICATION_RESULT.CHECKING_2:
      alert("개발중!");
