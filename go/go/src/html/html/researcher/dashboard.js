...
function onClickApplication(e, a) {
  switch (e) {
    case 0:
      switch (
        (g_AppInfo.initWithAppObj(writing_saved_list[a]) ||
          alert("Fail to ApplicationInfo Init!"),
        writing_saved_list[a].judge_type)
      ) {
        ...
        default:
          return void alert(
            `JUDGE_TYPE Error!! (${writing_saved_list[a].judge_type})`
          );
      }
      break;
    case 1:
  ...
  switch (e) {
    case 0:
      switch (writing_saved_list[a].application_type) {
        ...
        default:
          return void alert(
            `application_type Error!! (${writing_saved_list[a].application_type})`
          );
      }
      break;
    case 1:
      ...
      switch (writing_saved_list[a].application_result) {
        case 0:
          g_AppInfo.saveParamsAndNavigate(
            APP_NAVIGATION.IACUC.PAGE_INFO[0].URL
          );
          break;
        case 1:
  ...
  switch (e) {
    case 0:
      switch (writing_saved_list[a].application_result) {
        case 0:
          g_AppInfo.saveParamsAndNavigate(
            APP_IBC_NAVIGATION.IBC.PAGE_INFO[0].URL
          );
          break;
        case 1:
          g_AppInfo.saveParamsAndNavigate(
            "./IBC/application_list-IBC_review.html"
          );
      }
      break;
    case 1:
...
$(function () {
  ...
  API.load({
    ...
    success: function (e) {
      $(".writing_cnt").text(e.writing_cnt),
        ...
        $.each(e.writing, function (a, i) {
          ...
          _.addClass(`${i.judge_type_str}`).addClass(`${n}`).addClass(`${d}`),
            ...
            0 == i.application_result
              ? (_.find(".link_btn").text("계속 작성"),
                _.find(".link_btn").addClass("btn btn-primary btn_xxs"))
              : (_.find(".link_btn").text("보완 작성"),
      ...
      if ((i.empty(), e.checking.length))
        $.each(e.checking, function (a, t) {
          ...
          var d = "";
          if (t.application_result === IPSAP.APPLICATION_RESULT.SUPPLEMENT)
            d = "supplement";
          var _ = cardObjTmp.clone();
          _.addClass(`${t.judge_type_str}`).addClass(`${n}`).addClass(`${d}`),
            ...
            _.find(".link_btn").addClass(
              "btn btn-outline-secondary btn_xxs disabled"
            ),
            _.find(".link_btn").attr("onclick", `${r}`),
            i.append(_);
        });
                ...
                "closed" == i &&
                  t
                    ...
                    .attr({
                      ...
                      title:
                        '실험 기간이 만료되었습니다. "종료 보고서"를 제출해 주세요.',
                    });
  ...
  switch (e) {
    case 0:
      switch (writing_saved_list[a].application_result) {
        case 0:
          g_AppInfo.saveParamsAndNavigate(
            APP_IRB_NAVIGATION.IRB.PAGE_INFO[0].URL
          );
          break;
        case 1:
          g_AppInfo.saveParamsAndNavigate(
            "./IRB/application_list-IRB_review.html"
          );
      }
      break;
    case 1:
...
function navigateIRB_change(e, a) {
  switch (e) {
    case 0:
      g_AppInfo.saveParamsAndNavigate(
        "./IRB/experiment_list-IRB_review_change.html"
      );
      break;
    case 1:
      break;
